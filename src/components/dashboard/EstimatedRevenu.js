...
const EstimatedRevenu = () => {
    return (
        <div className='w-full pt-[20px] pb-[30px] px-[20px] border border-[#DBE0E5] rounded-lg'>
            <div className='text-[#000000] dark:text-white font-inter font-medium text-base text-center pb-[42px]'>Estimated Net Revenue</div>
            ...
            <div className='flex gap-4 items-center justify-center lg:justify-start flex-wrap'>
                <div className='p-[15px] border border-[#EFEFEF] rounded-lg'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='text-[#1D2630] dark:text-white font-inter font-medium text-[14px]'>Yesterday VS Same Day Last Week</div>
                ...
                <div className='p-[15px] border border-[#EFEFEF] rounded-lg'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='text-[#1D2630] dark:text-white  font-inter font-medium text-[14px]'>Last 7 days VS Previous 7 days</div>
                        <MoreVertIcon fontSize='small' />
                    </div>
                    <div className='bg-[#F8F9FA] rounded-lg p-[15px] w-full flex items-center gap-4 mt-[15px]'>
                ...
                <div className='p-[15px] border border-[#EFEFEF] rounded-lg'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='text-[#1D2630] dark:text-white  font-inter font-medium text-[14px]'>Last 30 days VS Previous 30 days</div>
                        <MoreVertIcon fontSize='small' />
                    </div>
                    <div className='bg-[#F8F9FA] rounded-lg p-[15px] w-full flex items-center gap-4 mt-[15px]'>
